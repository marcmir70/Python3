...
class Projeto:
    ...
    def procurar(self, descricao):
        # Possível IndexError - para descrição inexistente
...
def main():
    ...
    for tarefa in casa:   # com método iter, não precisa mais do ".tarefas"
        print(f'- {tarefa}')
    print(casa)
    ...
    for tarefa in mercado:   # com método iter, não precisa mais do ".tarefas"
        print(f'- {tarefa}')
    print(mercado)    
